...
namespace LabWork29
{
    public class LogArchiveSerivce : BackgroundService
    {
        private readonly ILogger<LogArchiveSerivce> _logger;
        ...
        public LogArchiveSerivce(ILogger<LogArchiveSerivce> logger, IConfiguration configuration)
        {
            _logger = logger;
